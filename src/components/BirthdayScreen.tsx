...
const phrases = [
  ...
  "Snoopy dice: Sé suave contigo mismo, estás haciendo lo mejor que puedes 🦢",
  "Snoopy dice: El pasado es un maestro, no un castigo. Aprende y avanza 🚀",
  ...
  "Snoopy dice: Tu voz interior te está guiando, escucha con atención y calma 👂",
  "Snoopy dice: La magia sucede fuera de tu zona de confort, ¡da un paso! 👟",
  "Snoopy dice: Recarga tu energía rodeándote de lo que te da paz y brillo 🔆",
  "Snoopy dice: No hay errores, solo lecciones en tu camino hacia la grandeza 💫",
  "Snoopy dice: Confía en la belleza de lo desconocido, lo mejor está por venir 🔮",
  "Snoopy dice: Eres la obra de arte más importante que jamás crearás 🎨",
  "Snoopy dice: Un corazón en paz es el campo más fértil para la felicidad 🏡",
  "Snoopy dice: Lo que resistes, persiste. Lo que aceptas, se transforma 🦋",
  "Snoopy dice: Sé tan amable con tu alma como lo eres con tu mejor amigo 💞",
  "Snoopy dice: Recuerda que las flores necesitan lluvia para florecer 🌧️🌸",
  "Snoopy dice: Tu coraje no es la ausencia de miedo, sino el paso a pesar de él 🦁",
  "Snoopy dice: La paciencia es el puente entre el deseo y la manifestación 🌉",
  "Snoopy dice: Deja que tu corazón sea tu brújula en las decisiones difíciles 🧭",
  "Snoopy dice: Pequeños cambios diarios llevan a resultados monumentales a largo plazo 🌟",
  "Snoopy dice: Date permiso para soltar la perfección y abrazar el progreso 💖",
  "Snoopy dice: Tu historia es poderosa; no la minimices ni la compares con otra 📖",
  "Snoopy dice: Busca la belleza en el caos, siempre hay luz esperando ser encontrada 💡",
  "Snoopy dice: Un café, un abrazo, un suspiro... celebra los placeres sencillos de hoy ☕",
];

const carta ="La vida es demasiado corta como para no hacer lo que quieres, vive, ama y disfruta 💫";
